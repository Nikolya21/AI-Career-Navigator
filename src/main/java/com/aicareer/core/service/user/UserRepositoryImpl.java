...
public class UserRepositoryImpl implements UserRepository {
  ...
  private final UserSkillRepository userSkillRepository; // ← добавили зависимость

  public UserRepositoryImpl(DataSource dataSource, UserSkillRepository userSkillRepository) {
  ...
  public User save(User user) {
    ...
    try (Connection conn = dataSource.getConnection();
      ...
      if (user.getId() == null) {
        ...
        stmt.setTimestamp(6, Timestamp.from(now)); // ✅ исправлено
