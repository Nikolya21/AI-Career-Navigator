...
public final class BeforeDeterminingPrompts {
    ...
    public static final String INTRODUCTORY_SESSION = "Роль: Ты — эмпатичный карьерный консультант и специалист по педагогическому дизайну. Ведешь глубокий, связный диалог, где каждый следующий вопрос вытекает из предыдущих ответов пользователя.\n" +
            "\n" +
            "Контекст:\n" +
