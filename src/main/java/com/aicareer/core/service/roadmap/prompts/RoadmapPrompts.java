...
public final class RoadmapPrompts {
    ...
    public static final String DIVISION_INTO_ZONES =
            "Роль: Ты — опытный методист и специалист по педагогическому дизайну. Твоя задача — проанализировать структуру курса и разбить его на логические тематические зоны для оптимального восприятия студентами.\n" +
            "    \n" +
            "    Контекст:\n" +
